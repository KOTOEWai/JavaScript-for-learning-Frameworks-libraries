...
JavaScript မှာ **Operators (လုပ်ဆောင်ချက် သင်္ကေတများ)** ဆိုတာ ကိန်းဂဏန်းတွေ၊ စာသားတွေ ဒါမှမဟုတ် Variables တွေကို တွက်ချက်တာ၊ နှိုင်းယှဉ်တာ၊ တန်ဖိုးထည့်တာ စတဲ့ အလုပ်တွေခိုင်းဖို့ သုံးတဲ့ သင်္ကေတလေးတွေ ဖြစ်ပါတယ်။ 

<div align="right"><a href="#table-of-contents">↑ Back to Top</a></div>

---

### **1. တွက်ချက်ခြင်း သင်္ကေတများ (Arithmetic Operators)**

သင်္ချာ တွက်ချက်မှုတွေကို လုပ်ဆောင်ပေးတဲ့ သင်္ကေတတွေပါ။

- **`+` (အပေါင်း)** : ပေါင်းခြင်း (စာသားတွေကို ဆက်တဲ့နေရာမှာလည်း သုံးပါတယ်)
- **`-` (အနှုတ်)** : နှုတ်ခြင်း
- **`*` (အမြှောက်)** : မြှောက်ခြင်း
- **`/` (အစား)** : စားခြင်း
- **`%` (အကြွင်း)** : စားကြွင်းရှာခြင်း (ဥပမာ: `10 % 3` ဆိုလျှင် `1` ကြွင်းပါတယ်)
- **`**` (ထပ်ကိန်း)** : ထပ်ကိန်းတင်ခြင်း (ဥပမာ: `2 ** 3` ဆိုလျှင် 2³ = `8`)
...
### **2. တန်ဖိုးထည့်ခြင်း သင်္ကေတများ (Assignment Operators)**

Variable တစ်ခုထဲကို တန်ဖိုး (Value) တွေ ထည့်တဲ့နေရာမှာ သုံးပါတယ်။

- **`=`** : တန်ဖိုး ထည့်ခြင်း (`x = 5`)
- **`+=`** : ရှိပြီးသားကို ထပ်ပေါင်းထည့်ခြင်း (`x += 3` ဆိုတာ `x = x + 3` နဲ့ အတူတူပါပဲ)
- **`-=`** : ရှိပြီးသားထဲက နှုတ်ထည့်ခြင်း (`x -= 2`)
- **`*=`** : ရှိပြီးသားကို မြှောက်ထည့်ခြင်း (`x *= 2`)
- **`/=`** : ပြီးသားကို စားထည့်ခြင်း (`x /= 2`)

**ဥပမာ:**
```js
let score = 10;
score += 5; // score ဟာ 15 ဖြစ်သွားပါတယ်
```
...
### **3. နှိုင်းယှဉ်ခြင်း သင်္ကေတများ (Comparison Operators)**

တန်ဖိုး နှစ်ခုကို နှိုင်းယှဉ်တဲ့အခါမှာ သုံးပါတယ်။ ရလဒ်အနေနဲ့ မှန်/မှား (`true`/`false`) ကိုသာ ပြန်ပေးပါတယ်။

- **`==`** : တန်ဖိုး အတူတူပဲလား စစ်ခြင်း (Data Type မတူလည်း တူတယ်လို့ သတ်မှတ်နိုင်တယ်)
- **`===`** : တန်ဖိုးရော၊ Data Type ပါ အတိအကျ တူသလား စစ်ခြင်း (Strict Equality - ဒါကိုပဲ အဓိက သုံးသင့်ပါတယ်)
- **`!=`** : မတူဘူးလား စစ်ခြင်း
- **`!==`** : တန်ဖိုးရော၊ Data Type ပါ အတိအကျ မတူဘူးလား စစ်ခြင်း
- **`>`** : ကြီးသလား
- **`<`** : ငယ်သလား
- **`>=`** : ကြီးသည် သို့မဟုတ် ညီသလား
- **`<=`** : ငယ်သည် သို့မဟုတ် ညီသလား

**ဥပမာ:**
```js
console.log(5 == "5");  // true  (တန်ဖိုးတူလို့)
console.log(5 === "5"); // false (Data Type မတူလို့)
```
...
### **4. ယုတ္တိဗေဒ သင်္ကေတများ (Logical Operators)**

Conditions အခြေအနေ ၂ ခု သို့မဟုတ် အများကြီးကို တွဲပြီး စစ်ဆေးတဲ့အခါ သုံးပါတယ်။

- **`&&` (AND - နှစ်ခုလုံးမှန်မှ)**: Conditions အားလုံးမှန်မှ `true` ရပါမယ်။
- **`||` (OR - တစ်ခုမှန်တာနဲ့)**: Condition တစ်ခုလေး မှန်နေတာနဲ့ `true` ရပါမယ်။
- **`!` (NOT - ပြောင်းပြန်)**: မှန်နေရင် မှားတယ်၊ မှားနေရင် မှန်တယ်လို့ ပြောင်းပြန်လှန်ပါတယ်။
...
console.log(hasMoney && isHungry); // true (စားလို့ရပြီ)
console.log(!hasMoney); // false (ပိုက်ဆံရှိတာကို ပြောင်းပြန်လှန်လိုက်တယ်)
```
...
### **5. တိုးခြင်း၊ လျော့ခြင်း သင်္ကေတများ (Increment & Decrement)**

Variable တစ်ခုရဲ့ တန်ဖိုးကို `1` တိုးချင်၊ လျော့ချင်တဲ့အခါ သုံးပါတယ်။ (အထူးသဖြင့် Loop တွေမှာ သုံးလေ့ရှိပါတယ်)

- **`++`** : 1 တိုးတယ် (`x++` ဆိုတာ `x = x + 1` ပါပဲ)
- **`--`** : 1 လျော့တယ် (`x--`)
...
*မှတ်ချက် - `++x` (Pre-increment) နဲ့ `x++` (Post-increment) ဆိုပြီး ရှေ့နောက် ထားပုံ ကွာခြားမှုလေးတွေ ရှိပါတယ်။*

<div align="right"><a href="#table-of-contents">↑ Back to Top</a></div>

---

### **6. စာသားများကို ဆက်ခြင်း (String Concatenation)**

အပေါင်းသင်္ကေတ (`+`) ဟာ ကိန်းဂဏန်းတွေမှာဆိုရင် ပေါင်းပေးပေမယ့်၊ စာသား (String) တွေနဲ့ တွဲလာရင်တော့ စာသားတစ်ခုနဲ့တစ်ခု ဆက်ပေးတဲ့ အလုပ်ကို လုပ်ပါတယ်။

**ဥပမာ:**
```js
let firstName = "Ko";
let lastName = "Toe";
console.log(firstName + " " + lastName); // "Ko Toe"
```
...
### **7. အနှစ်ချုပ် (Summary)**

- **Arithmetic** (`+`, `-`, `*`, `/`, `%`) - တွက်ချက်မှုတွေအတွက် သုံးပါ။
- **Assignment** (`=`, `+=`, `-=`) - Variable ထဲ တန်ဖိုး ထည့်/ပေါင်းထည့် ဖို့ သုံးပါ။
- **Comparison** (`===`, `!==`, `>`, `<`) - အမှားအမှန် နှိုင်းယှဉ်ဖို့ သုံးပါ။ အမြဲတမ်း `===` (Strict Equality) ကိုသာ ဦးစားပေးသုံးပါ။
- **Logical** (`&&`, `||`, `!`) - Condition တွေ အများကြီး တွဲစစ်ဖို့ သုံးပါ။
- **Increment/Decrement** (`++`, `--`) - 1 တိုး/လျော့ ဖို့ သုံးပါ။
...
JavaScript မှာ **Conditions (အခြေအနေစစ်ဆေးခြင်း)** ဆိုတာ သတ်မှတ်ထားတဲ့ အခြေအနေ မှန်/မမှန် ပေါ်မူတည်ပြီး ဘယ် Code ကို ဆက်လုပ်ရမလဲ ဆုံးဖြတ်ပေးတဲ့ လုပ်ဆောင်ချက် ဖြစ်ပါတယ်။
...
`if` ကို သတ်မှတ်ထားတဲ့ condition က `true` (မှန်ကန်) ဖြစ်မှပဲ အထဲက code တွေကို အလုပ်လုပ်စေချင်တဲ့အခါ သုံးပါတယ်။

**ပုံစံ:**
```js
if (condition) {
  // condition မှန်ရင် လုပ်မယ့်အလုပ်
}
```
...
if (age >= 18) {
  console.log("You are an adult."); // မှန်တဲ့အတွက် ဒီစာ ပေါ်ပါမယ်
}
```
...
`if...else` ကို `if` condition မှန်ရင် တစ်မျိုး၊ **မမှန်ရင် (false ဖြစ်ရင်)** နောက်တစ်မျိုး လုပ်ချင်တဲ့အခါ သုံးပါတယ်။
...
if (isRaining) {
  ...
  console.log("Enjoy the sunny day!"); // isRaining က false ဖြစ်တဲ့အတွက် ဒီစာ ပေါ်ပါမယ်
}
```
...
### **3. `else if` Statement (အခြေအနေများစွာ စစ်ဆေးခြင်း)**

အခြေအနေ တစ်ခုမကဘူး၊ ၂ ခု ၃ ခုလောက် ဆက်တိုက် စစ်ဆေးချင်တဲ့အခါ `else if` ကို သုံးပါတယ်။
...
if (score >= 90) {
  ...
  console.log("Grade: B"); // 85 က 80 ထက်ကြီးတဲ့အတွက် ဒီစာ ပေါ်ပါမယ်
} else if (score >= 70) {
  console.log("Grade: C");
} else {
  console.log("Grade: F");
...
```
*သတိပြုရန်:* မှန်တဲ့ condition တစ်ခုတွေ့တာနဲ့ အဲ့ဒီထဲကို ဝင်သွားပြီး အောက်က condition တွေကို ဆက်မစစ်တော့ပါဘူး။
...
Variable တစ်ခုတည်းက တန်ဖိုး အမျိုးမျိုး ပြောင်းနိုင်တာကို အခြေအနေ (Cases) အများကြီးနဲ့ တိုက်စစ်ချင်တဲ့အခါ `if...else if` တွေ အများကြီးရေးမယ့်အစား `switch` ကို သုံးတာ ပိုရှင်းပါတယ်။
...
switch (expression) {
  ...
  case value2:
    ...
    break;
  default:
    // ဘယ်ဟာနဲ့မှ မကိုက်ညီရင် လုပ်မယ့်အလုပ်
}
```
...
switch (day) {
  case 1:
    dayName = "Monday";
    break; // break မပါရင် အောက်ကဟာတွေပါ ဆက်အလုပ်လုပ်သွားပါမယ်
  case 2:
    dayName = "Tuesday";
    break;
  case 3:
...
`if...else` ကို မြန်မြန်ဆန်ဆန် တစ်ကြောင်းတည်းနဲ့ ရေးချင်တဲ့အခါ သုံးပါတယ်။ (အများဆုံး သုံးလေ့ရှိပါတယ်)
...
### **6. Logical Operators တွေနဲ့ တွဲသုံးခြင်း**

Condition ၂ ခု သို့မဟုတ် အများကြီးကို တပြိုင်နက်တည်း စစ်ဆေးချင်တဲ့အခါ `&&`, `||`, `!` တို့ကို သုံးပါတယ်။

- **AND (`&&`)** - Condition **အားလုံး** မှန်မှ (true) ဖြစ်မှ အလုပ်လုပ်မယ်။
```js
let hasTicket = true;
let isVip = false;
...
if (hasTicket && isVip) {
  ...
  console.log("Access Denied."); // isVip မဖြစ်လို့ Access Denied ပေါ်မယ်
}
```

- **OR (`||`)** - Condition **တစ်ခုခု** မှန်တာနဲ့ (true) ဖြစ်တာနဲ့ အလုပ်လုပ်မယ်။
```js
let isWeekend = true;
let hasHoliday = false;

if (isWeekend || hasHoliday) {
  console.log("Let's go travel!"); // တစ်ခုမှန်တာနဲ့ အလုပ်လုပ်မယ်
}
```

- **NOT (`!`)** - မှန်နေရင် မှားတယ်၊ မှားနေရင် မှန်တယ်လို့ ပြောင်းပြန်လှန်ပစ်ပါတယ်။
```js
let isLoggedIn = false;

if (!isLoggedIn) {
  console.log("Please log in first."); // false ကို ! က true ပြောင်းလိုက်လို့ ဒီထဲဝင်လာမယ်
}
```
...
### **7. Truthy နှင့် Falsy Values**

Condition ထဲမှာ Boolean အစစ် (`true`/`false`) မဟုတ်တဲ့ တခြား Data တွေ ထည့်ရင် JavaScript က အလိုအလျောက် သတ်မှတ်ပေးတဲ့ တန်ဖိုးတွေ ရှိပါတယ်။

- **Falsy Values** (False လို့ သတ်မှတ်တဲ့ အရာ ၆ ခုသာ ရှိပါသည်)
  - `false`
  - `0`
  - `""` (Empty string)
  - `null`
...
- **Truthy Values** (အပေါ်က ၆ ခုကလွဲရင် ကျန်တာ အကုန် `true` လို့ သတ်မှတ်ပါတယ်)
  - `"0"` (စာသားဖြစ်နေလို့ true)
  - `"false"` (စာသားဖြစ်နေလို့ true)
  - `[]` (Array အလွတ် true)
  - `{}` (Object အလွတ် true)
  - `function(){}` (Function အလွတ် true)

**ဥပမာ:**
```js
let name = ""; // Empty string ဖြစ်လို့ falsy value

if (name) {
  console.log("We have a name!");
} else {
  console.log("Name is missing."); // အထဲက empty string (false) ဖြစ်နေလို့ ဒီထဲဝင်လာမယ်
}
```
...
### **8. အနှစ်ချုပ် (Summary)**

Condition တွေဟာ ပရိုဂရမ်တစ်ခုရဲ့ စဉ်းစားတွေးခေါ်နိုင်စွမ်းကို ဖန်တီးပေးတာဖြစ်ပါတယ်။ `if`, `else if`, `else` တွေကနေ စပြီး `switch` နဲ့ Ternary (`? :`) တွေကို နေရာနဲ့ အခြေအနေ ကိုက်ညီသလို ထည့်သွင်း အသုံးပြုရပါမယ်။ Truthy နဲ့ Falsy value တွေကို သေချာနားလည်ထားခြင်းဖြင့် condition တွေကို ပိုမိုတိုတောင်း သပ်ရပ်စွာ ရေးသားနိုင်ပါတယ်။
